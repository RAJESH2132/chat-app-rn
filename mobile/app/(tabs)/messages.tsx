            ...
            <View className="flex-1">
              <View className="flex-row items-center justify-between mb-1">
                <View className="flex-row items-center gap-1">
                  ...
                  <Text className="ml-1 text-sm text-gray-500">@{conversation.user.username}</Text>
                </View>
          ...
          <SafeAreaView className="flex-1">
            ...
            <View className="flex-row items-center px-4 py-3 border-b border-gray-100">
              ...
              <View className="flex-1">
                ...
                <Text className="text-sm text-gray-500">@{selectedConversation.user.username}</Text>
              </View>
            </View>
                ...
                {selectedConversation.messages.map((message) => (
                  ...
                  >
                    ...
                    <View className={`flex-1 ${message.fromUser ? "items-end" : ""}`}>
                      ...
                      <Text className="mt-1 text-xs text-gray-400">{message.time}</Text>
                    </View>
                  </View>
                ))}
              </View>
